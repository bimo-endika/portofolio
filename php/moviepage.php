        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link active" href="halamanutama.php">home</a>
                    </li>

                    <?php if ($isAdmin) : ?>
                        <li class="nav-item">
                            <a class="nav-link" href="../admin/addmovie.php?genre=<?= urlencode($genre); ?>">
                                Add Movie
                            </a>
                        </li>
                    <?php endif; ?>
                                ...
                                <div class="mt-auto">
                                    ...
                                    <?php if ($isAdmin) : ?>
                                        <form method="POST" class="mt-2">
                                            ...
                                            <button type="submit"
                                                    name="update_watched"
                                                    class="btn <?= $movie['watched'] ? 'btn-success' : 'btn-secondary'; ?> w-100">
                                                <?= $movie['watched'] ? '✓ Sudah Ditonton' : 'Mark as Watched'; ?>
                                            </button>
                                        </form>
